...
export const reativarMaterial = (id: string) => requisitar<void>(`/materiais/${id}/reativar`, 'POST')
...
export const reativarServico = (id: string) => requisitar<void>(`/servicos/${id}/reativar`, 'POST')
