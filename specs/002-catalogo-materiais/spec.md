...
**Data:** 2026-09-19  
**Status:** clarificada — pronta para planejamento
...
O marceneiro poderá cadastrar, buscar, editar e inativar materiais e serviços próprios para formar seu catálogo. Ficam fora orçamento, cálculo, clientes, PDF, histórico de custo (RF16) e congelamento de valores de itens registrados (RF14, incremento 003).

Será demonstrado por telas de catálogo com cadastro, busca, edição e inativação, comprovando isolamento entre marcenarias.
...
- Custo vazio, zero ou negativo não grava; `1,2350` é preservado sem ponto flutuante binário.
