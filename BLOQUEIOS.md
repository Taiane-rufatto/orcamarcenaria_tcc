...
| B03 | Spec Kit ainda não instalado no repositório (D008) | Início do ciclo formal de Specs | Taiane | Aberto |
| B09 | PostgreSQL local ainda não instalado/configurado | Testes de integração e migrações do incremento 001 | Taiane | Aberto |
| B04 | Repositório GitHub não criado | Toda a rastreabilidade exigida na defesa | Taiane | Aberto — fazer primeiro |
